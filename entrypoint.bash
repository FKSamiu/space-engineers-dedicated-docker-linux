...
#  exit 131
#else
#  sed -i '/LoadWorld/c\<LoadWorld>Z:\\appdata\\space-engineers\\World\\World\\RelikServer\\Mission01\\Sandbox.sbc</LoadWorld>' /appdata/space-engineers/World/SpaceEngineers-Dedicated.cfg
